    ...
    try:
        ...
        try:
            ...
            if os.path.exists(out_path):
                ...
                # Create a backup copy with fallback for TEMP
                temp_dir = os.environ.get("TEMP", "C:\\Temp")
                if not os.path.exists(temp_dir):
                    os.makedirs(temp_dir, exist_ok=True)
                backup_dir = os.path.join(temp_dir, "DailyTimeBackup")
                ...
                try:
                    ...
                    st.warning(f"Backup failed at {backup_path}: {e}")
                ...
                st.error(f"File not found at: {out_path} after save attempt")
